...
import com.de.adminApp.pages.Company;

import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;
import cucumber.api.java.en.When;

public class CompanyStepDefinition extends GlobalStepDefinition {
	...
	public Company.EditCompany editCompany;
	...
	public void admin_click_on_Add_companies() {
		companies = new Companies(getDriver());
		companies.lnk_Add.click();
		createCompany = new Company.CreateCompany(getDriver());
	...
	public void company_must_be_created() {
		Assert.assertThat(globalPage.getCellFromList("Name", companyName).getText(), Matchers.containsString(companyName));
	...
	public void edit_company_with_name(String compName) {
		editCompany = new Company.EditCompany(getDriver());
		companyName = compName;
	...
	public void admin_click_on_edit_company_icon_in_actions() {
		new Companies.Actions(getDriver()).getAction("edit").click();
	}
