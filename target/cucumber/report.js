...
formatter.step({
  "line": 11,
  "name": "Create a new Company \"testCompany6Nov19\" in adminApp",
  "matchedColumns": [
    0
  ],
  "keyword": "When "
...
formatter.step({
  "line": 12,
  "name": "Create \"testUser3Oct19\" and assign \"testCompany6Nov19\" in adminApp",
  "matchedColumns": [
    0,
    1
  ],
...
formatter.step({
  "line": 13,
  "name": "Login DE webApp with \"testUser3Oct19\"",
  "matchedColumns": [
    1
  ],
  "keyword": "And "
...
formatter.step({
  ...
  "line": 16,
  "name": "Create a new location \"2Oct\" with required basic and notification tab details",
  "matchedColumns": [
    2
  ],
  "keyword": "And "
...
formatter.step({
  "line": 22,
  "name": "Create a new product list as \"productList1\" and assign to \"2Oct\"",
  "matchedColumns": [
    2,
    4
  ],
...
formatter.uri("EtoEfromOrderEdgeMultiple.feature");
formatter.feature({
  "line": 2,
  "name": "this feature targets the end to end Ordering flow",
  "description": "",
